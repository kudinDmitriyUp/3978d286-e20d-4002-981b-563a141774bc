...
export const metadata: Metadata = {
  title: "AutoElite - Premium Car Showroom & Dealership",
  description: "Discover luxury and reliable vehicles at AutoElite. Premium car showroom with exceptional service, financing options, and comprehensive warranties.",
  keywords: "car showroom, luxury cars, car dealership, premium vehicles, auto sales, car financing, test drive",
  ...
  openGraph: {
    ...
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763150334680-4zh2tibn.jpg",
      alt: "AutoElite luxury car showroom"
    }]
  },
  twitter: {
    ...
    title: "AutoElite - Premium Car Showroom & Dealership",
    description: "Discover luxury and reliable vehicles at AutoElite. Premium car showroom with exceptional service, financing options, and comprehensive warranties.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763150334680-4zh2tibn.jpg"]
  },
  robots: {
    index: true,
    follow: true
